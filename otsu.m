function [IDX,thresh,sep] = otsu(I,n)
%OTSU Global image thresholding/segmentation using Otsu's method.
%   [IDX,thresh,sep] = OTSU(I,N) segments the image I into N classes by means of Otsu's
...
%   non-finite (NaN or Inf) pixels. thresh is a n-1x1 vector containing the
%   threshold values between classes. sep is the separability criterion.
%
%   Notes:
%   -----
...
thresh = thresh/255*(maxI-minI)+minI;
% IDX(~isfinite(I)) = 0;  % not necessary??
